          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Hello ${toTitleCase(_userModel!.name ?? '')},',
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: (String? value) {
                              setState(() {
                                ...
                                _selectedLoanProductId = _loanOffers.firstWhere((offer) => offer.duration == int.parse(value!.split(' ')[0])).loanProductId;

                                _selectedLoanOffer = _loanOffers.firstWhere((offer) => offer.loanProductId == _selectedLoanProductId);
                            ...
                            items: _repaymentItems.map((valueItem) {
                              return DropdownMenuItem<String>(
                                  value: valueItem, child: Text(valueItem, style: GoogleFonts.montserrat(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff606060))));
                            }).toList(),
                          ),
                        ),
                      ),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                      onPressed: _isRequesting || _isFetchingLoanOffers
                          ? null
                          : () {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Loan limit: ${NumberFormat.currency(symbol: 'KES ').format(_loanLimit ?? 0.00)}",
                  style: GoogleFonts.montserrat(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xff5C5C5C)),
                ),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                      ...
                      child: _loanProcessing ? const CircularProgressIndicator() : Text('REQUEST LOAN', style: GoogleFonts.montserrat(fontWeight: FontWeight.w500, fontSize: 16, color: Colors.white)),
                      style: ElevatedButton.styleFrom(
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(11)),
                        backgroundColor: Colors.transparent,
                        tapTargetSize: MaterialTapTargetSize.shrinkWrap,
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: styles.blackGreyText),
          ),
        ],
      ),
    );
